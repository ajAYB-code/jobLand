        ...
        <div class="account-container p-4">
            ...
            <form action="" class="form w-50" method="POST">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="firstName" id="" class="form-control" value="{{old('firstName') ?? Auth::user()->firstName}}">
                            @error('firstName')
                    ...
                    <div class="col">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="lastName" id="" class="form-control" value="{{old('lastName') ?? Auth::user()->lastName}}">
                            @error('lastName')
                            <p style="font-size: 13px;color:red;">{{$message}}</p>
                            @enderror
                        </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="email" id="" class="form-control" value="{{old('email') ?? Auth::user()->email}}">
                    @error('email')
                    <p style="font-size: 13px;color:red;">{{$message}}</p>
                    @enderror
                </div>
